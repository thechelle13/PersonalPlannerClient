...
export const getEvents = async () => {
  try {
    const response = await fetch('https://personalplanner-api-app-3vixh.ondigitalocean.app/events', {
      method: 'GET',
      headers: {
...
export const getUserEvents = async () => {
  try {
    ...
    const response = await fetch(`https://personalplanner-api-app-3vixh.ondigitalocean.app/events/list_user_events`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        Accept: 'application/json',
  ...
  export const getEventDetails = async (eventId) => {
    try {
      const response = await fetch(`https://personalplanner-api-app-3vixh.ondigitalocean.app/events/${eventId}`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          Accept: 'application/json',
  ...
  export const rsvpToEvent = async (eventId) => {
    try {
      ...
      if (!currentUser || !currentUser.token) {
        ...
        const response = await fetch(`https://personalplanner-api-app-3vixh.ondigitalocean.app/events/${eventId}/rsvp`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json',
                Accept: 'application/json',
  ...
  export const getEventsByCategory = async (categoryId) => {
    try {
      const url = `https://personalplanner-api-app-3vixh.ondigitalocean.app/events/list_by_category?category_id=${categoryId}`;
